...
public class UppclDashboardController {
    ...
    public ResponseEntity<LookupDetail> creatlookUpDetail(@Valid @RequestBody LookupDetail lookupDetail) throws InputMismatchException {
	...
	public GetEmpDetailDTO getEmpDetails(@RequestParam String fname)
	{
		GetEmpDetailDTO detail = uppclService.getEmpDetails(fname);
